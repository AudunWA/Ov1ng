...
public class TegningOv1_1JOGL extends JPanel implements GLEventListener {
    ...
    public void drawGLScene(GLAutoDrawable glDrawable) {
        ...
        // Triangle 1
        gl.glColor3f(1f, 1f, 0f); // Set the Colour to Red
        ...
        // Quad 1
        gl.glColor3f(0f, 1f, 0f); // Set the Colour to Green
        gl.glBegin(GL_QUADS); // Start drawing a Quad
        gl.glVertex3f(0f, 1f, 0f); // Top Left
        gl.glVertex3f(1f, 1f, 0f); // Top Right
        gl.glVertex3f(1, 0f, 0f); // Bottom Right
        gl.glVertex3f(0, 0f, 0f); // Bottom Left
        gl.glEnd(); // End drawing the Quad

        gl.glTranslatef(-3f, -3f, 0f); // Move Right 3 Units

        // Triangle 2
        gl.glColor3f(1f, 0.5f, 0.5f); // Set the Colour to Red
        gl.glBegin(GL_TRIANGLES); // Start drawing triangle 1
        gl.glVertex3f(0f, 1f, 0f); // Top
        gl.glVertex3f(-1f, 0f, 0f); // Bottom Left
        gl.glVertex3f(1f, 0f, 0f); // Bottom Right
